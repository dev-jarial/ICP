...
class Company(models.Model):
    ...
    key_capabilities = models.TextField(blank=True, null=True)
    ...
    partner_category = models.CharField(max_length=255, blank=True, null=True)
    ...
    case_studies_available = models.BooleanField(default=False)
